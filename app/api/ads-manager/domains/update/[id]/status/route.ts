...
import { ToggleDomainManagerServiceStatusProps } from "@/lib/features/domains/type/DomainManagerServiceProps";
...
export const PUT = async (
  ...
  const data: ToggleDomainManagerServiceStatusProps = await request.json();
